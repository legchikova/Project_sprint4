...
import pages.ListFAQ;

import static org.junit.Assert.assertEquals;

@RunWith(Parameterized.class)
public class ListFAQTest {
    private final WebDriver driver;
    private final int elementNumber;
    private final String expected;

    public ListFAQTest(int elementNumber, String expected){
    ...
    public static Object[][] getAnswers() {
        ...
        public void checkAnswers () {
            ...
            ListFAQ objListFAQ = new ListFAQ(driver);
            objHomePage.closeCookie();
            objListFAQ.scrollToFAQ();
            objListFAQ.waitForLoadFAQ();
            assertEquals(expected, objListFAQ.getElementText(elementNumber));
        }
    @After
